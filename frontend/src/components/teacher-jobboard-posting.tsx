...
export default function TeacherJobPosting({ params }: { params: { id: number, experience: string, title:string, school_id: number,   salary_est: string,
  start_date: string,
  city: string,
  state: string } }) {
  ...
  return (
    ...
    <>
      <div className="list">
        ...
        <div>
          {<JobPostingTeacherButtons params={params}/>}
        </div>
      </div>
    </>
  );
